...
def run_instance_2():
    ...
    BETA = 1.5
    RHO = 0.05
    # sol = SOLUTION: [0 1 0 1 0 0 1 1 1], [10  6  8 12  9], PROFIT: 45 ????
    P = [4,10,2,6,2,4,8,12,9]
    C = [18,22,20,30]
    R = [[4,4,2,1,2,4,3,5,3], [6,6,3,3,3,2,4,4,5], [4,4,2,2,1,3,5,4,3], [5,5,1,2,5,8,2,3,2]]
    acs_for_subset(p=P, c=C, r=R, n_ants=NUMBER_OF_ANTS, max_iter=N_ITERS, alpha=ALPHA, beta=BETA, rho=RHO)
...
def run_instance_p08():
    ...
    BETA = 2
    RHO = 0.4
    # sol = SOLUTION: [0 1 0 1 0 0 1], [525 593 617], PROFIT: 13549094 x 13549094
